        ...
        >
          <View className="gap-8 py-4 pb-8">
            ...
            <View className="gap-4 pb-20">
              <Text className={`text-xl font-bold leading-6 px-4 ${theme === "dark" ? "text-white" : "text-[#1C0C11]"}`}>All Favorites</Text>
              ...
              {loading ? (
                  ...
                  <View className="px-4 py-8 items-center">
                    <Text className="text-gray-500 dark:text-gray-400 text-center text-base">
                      No favorite found. Try adjusting your search or filters.
                    </Text>
                  </View>
              )}
            </View>
