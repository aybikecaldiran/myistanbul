  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView contentContainerStyle={{ padding: 0, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        />
        <View className="p-6">
          <Text className="text-[28px] font-bold text-[#1c0c11] mb-4">About Us</Text>

          <Text className="text-[16px] text-[#444444] mb-4 leading-6">
          ...
          <Text className="text-[18px] font-bold text-[#1c0c11] mb-2">Introducing Istanbul Tourist Pass: Your Ultimate Travel Companion</Text>
          <Text className="text-[16px] text-[#444444] mb-4 leading-6">
          ...
          <Text className="text-[18px] font-bold text-[#1c0c11] mb-2">What Makes Istanbul Tourist Pass Special?</Text>

          <Text className="text-[16px] text-[#444444] mb-3 leading-6">1. Skip the Hassle, Enjoy the Best
          ...
          <Text className="text-[16px] text-[#444444] mb-3 leading-6">2. More Than Just a Pass
          ...
          <Text className="text-[16px] text-[#444444] mb-3 leading-6">3. Personalized Assistance Every Step of the Way.
          ...
          <Text className="text-[16px] text-[#444444] mb-3 leading-6">4. Virtual Tourist Guide
          ...
          <Text className="text-[18px] font-bold text-[#1c0c11] mb-2">Our Vision</Text>
          <Text className="text-[16px] text-[#444444] mb-4 leading-6">
          ...
          <Text className="text-[18px] font-bold text-[#1c0c11] mb-2">What's Included in the Istanbul Tourist Pass?</Text>
          <Text className="text-[16px] text-[#444444] mb-4 leading-6">- Free Entry to 100 + Top Attractions
          ...
          <Text className="text-[18px] font-bold text-[#1c0c11] mb-2">Join Us on Your Next Adventure</Text>
          <Text className="text-[16px] text-[#444444] mb-4 leading-6">
          ...
          <Text className="text-[14px] text-[#6b7280] mb-2 text-center">APP VERSION 1.0</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
